            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{ route('pageDashUser') }}">
                            {{ trans('backoffice.mainArea') }}
                        </a>
                    </li>
                    <li class="breadcrumb-item">
                        <a href="{{ route('pageCLedit', $user->id) }}">
                        ...
                        <div class="col-6 col-sm-6 col-md-6 col-xxl-6 col-xl-6">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <select class="form-select" aria-label="Default select example" name="userTipo"
                                    id="userTipo">
                                    <option disabled value="Colaborador" @if (isset($user->tipo) && $user->tipo == 'Colaborador') selected @endif>
                                        {{ trans('backoffice.userTipo1') }}
                                    </option>
                                </select>
                            </div>
                        </div>
