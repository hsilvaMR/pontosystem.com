...
<nav class="navbar navbar-expand-lg navbar-light bg-light headerBackoffice">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <!-- Navbar brand -->
            <a class="navbar-brand mt-2 mt-lg-0" href="{{ route('pageDashUser') }}">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item me-3 me-lg-0 dropdown">
                    ...
                    <a class="nav-link dropdown-toggle border border-1 border-primary" role="button"
                        ...
                        {{ json_decode(\Cookie::get('user_cookie'))->nome }}
                    </a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        {{-- ver conta --}}
                        <li>
                            <a class="dropdown-item" href="{{ route('pageCL') }}">
                        ...
                        {{-- editar conta   --}}
                        <li>
                            <a class="dropdown-item" href="{{route('pageCLedit',json_decode(Cookie::get("user_cookie"))->id) }}">
