        ...
        <tr>
            <td align="center" width="100%">
                <table style="font-size:14px;padding:8px 13px;color:#ffffff;background-color:#1266f1;">
                    <tr>
                        <td>
                            <a href="{{ route('pageRecu',['token' => $detalhes['token']]) }}" target="_blank"
                                style="color:#ffffff;text-decoration:none;">{!! trans('backoffice.btnAtive1') !!}</a>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table style="padding-top:40px;" border="0" cellpadding="0" width="100%">
        <tr>
            <td align="center" width="100%" style="color:#58595b;font-size:11px;line-height:15px;">
                {!! trans('backoffice.doesntWorkTx') !!} <a href="{{ route('pageRecu', ['token' => $detalhes['token']]) }}"
                    style="text-decoration:none;color:#2fb385;"
                    target="_blank">{{ route('pageRecu', ['token'=> $detalhes['token']]) }}</a>
            </td>
        </tr>
    </table>
@stop
